...
const DisplayIncome = ({amount, category, description,date,_id,user,deleteIncome}) => {
  return (
    <>
        <div className="flex border-[1px] rounded-md dark:border-opacity-25 dark:text-white border-white p-5 max-lg:px-1 max-lg:py-3 mb-4 flex-col gap-3 dark:bg-slate-700 bg-white-400 shadow-md w-full ">
